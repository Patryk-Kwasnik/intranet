        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-4">
                <div class="form-group">
                    ...
                    {!! Form::text('name', null, array('placeholder' =>  __('tasks.tasks_name'),'class' => 'form-control')) !!}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4">
                <div class="form-group">
                    <strong>{{ __('tasks.status') }}:</strong>
                    {!! Form::select('status', $statuses,[], array('class' => 'form-control')) !!}
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4">
                <div class="form-group">
                    ...
                    {!! Form::select('id_user_assigned', $employees,[], array('class' => 'form-control')) !!}
                </div>
            </div>
        </div>
        <div class="row">
